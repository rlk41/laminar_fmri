...
timeseries=$2
fsl_feat_dir=$3
title=$(basename $timeseries)

echo "# FEAT version number
...
set fmri(sscleanup_yn) 1

# Output directory
set fmri(outputdir) \"$fsl_feat_dir\"

# TR(s)
set fmri(tr) 1.500000
...
# Standard image
set fmri(regstandard) \"/usr/local/apps/fsl/6.0.4/data/standard/MNI152_T1_2mm_brain\"
...
# Total voxels
set fmri(totalVoxels) 774547200
...
# # High pass filter cutoff
# #set fmri(paradigm_hp) 30
# set fmri(paradigm_hp) 60

# # Total voxels
# set fmri(totalVoxels) 263839680
...
# # Custom EV file (EV 1)
# #set fmri(custom1) "/Volumes/Samsung_T3/Visual_VASO/180817_AND_V5_26/Layer_rest/boco/VASO_timecourse_LGN_mask.nii.dat"
# set fmri(custom1) \"$timeseries\"
