...
# the line would be --> 
export atlasList="hcp-mmp-b" #schaefer100-yeo17 schaefer200-yeo17 yeo17dil"
...
subj="warped_MP2RAGE"
inputFSDir="/media/richard/bfb1e328-6d97-4280-8331-5daeb988f70a/bandettini/subjects/${subj}"
outputDir="/media/richard/bfb1e328-6d97-4280-8331-5daeb988f70a/bandettini/subjects/${subj}/multiAtlasTT"
mkdir -p ${outputDir} || \
